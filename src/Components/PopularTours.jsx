        ...
        <div>
            <section className="pt-16 bg-white text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-6">
                    {tours.map(tour => (
                        <div key={tour.id} className="shadow rounded-lg overflow-hidden bg-gray-50 text-left">
                            ...
                            <div className="p-4 space-y-2">
                                ...
                                <Link to={`/tours/${tour.id}`} className="inline-block mt-2 bg-yellow-500 text-black font-semibold px-4 py-2 rounded hover:bg-yellow-600">
                                    View Details
                                </Link>
                            </div>
                        </div>
